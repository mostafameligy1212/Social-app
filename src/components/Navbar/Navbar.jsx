              ...
              {!token && (
                <>
                  ...
                  <li>
                    <NavLink
                      to={"/register"}
                      className="flex flex-col justify-center items-center p-2 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700  md:dark:hover:bg-transparent"
                    >
                      <MdOutlineCreate size={30} />
                      Register
                    </NavLink>
